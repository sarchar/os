...
struct net_device;
typedef s64 (net_device_transmit_packet_function)(struct net_device* ndev, u8 net_protocol, u8* dest_address, u8 dest_address_length, u8* packet, u16 packet_length);
