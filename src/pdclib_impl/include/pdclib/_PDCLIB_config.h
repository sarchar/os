...
#else
struct _internal_mtx_t { unsigned char mutex_lock[64]; unsigned long long owner_task_id; unsigned long lock_count; } __attribute__((aligned(8)));
typedef union { unsigned char _PDCLIB_mtx_t_data[ sizeof(struct _internal_mtx_t) ]; long int _PDCLIB_mtx_t_align; } _PDCLIB_mtx_t __attribute__((aligned(8)));
#endif
