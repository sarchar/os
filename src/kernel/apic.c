...
void apic_init()
{
    ...
    // write to registers 0x10-11 the value (0 << 56) | (0 << 16) | (0 << 15) | (0 << 13) | (0 << 11) | (0 << 8) | (33 < 0)
    u32 ioapic_irq = 19;
    u32 cpu_irq    = 80;
    u64 value = (0ULL << 56) | (0 << 16) | (0 << 15) | (0 << 13) | (0 << 11) | (0 << 8) | (cpu_irq << 0);
    *ioregsel = 0x10 + (ioapic_irq * 2);
    *ioregwin = (value & 0xFFFFFFFF);
    *ioregsel = 0x11 + (ioapic_irq * 2);
    *ioregwin = (value >> 32);

    // enable keyboard interrupt
    // write to registers 0x12-13 the value (0 << 56) | (0 << 16) | (0 << 15) | (0 << 13) | (0 << 11) | (0 << 8) | (33 < 0)
    value = (0ULL << 56) | (0 << 16) | (0 << 15) | (0 << 13) | (0 << 11) | (0 << 8) | (33 << 0);
    *ioregsel = 0x12;
    *ioregwin = (value & 0xFFFFFFFF);
    *ioregsel = 0x13;
    *ioregwin = (value >> 32);
